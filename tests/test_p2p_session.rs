...
fn test_create_session() {
    assert!(P2PSession::new(2, stubs::INPUT_SIZE, 7777).is_ok());
}

#[test]
#[serial]
fn test_add_player() {
    let mut sess = P2PSession::new(2, stubs::INPUT_SIZE, 7777).unwrap();
...
fn test_synchronize_p2p_sessions() {
    let mut sess1 = P2PSession::new(2, stubs::INPUT_SIZE, 7777).unwrap();
    let mut sess2 = P2PSession::new(2, stubs::INPUT_SIZE, 8888).unwrap();
